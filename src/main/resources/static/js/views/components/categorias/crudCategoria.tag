<categoria-crud>
    ...
    <div  class="row titulo-encabezado"  >
        <div  class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
            <h1 ><i class="fa fa-cog"></i>&nbsp {$.i18n.prop("categoria.titulo")}  </h1>
        </div>
        ...
        <div class="row">
            <div class="col-sx-12  col-lg-12  col-md-12 col-sm-12 " style="width:98.50%;">
                    <table id="tableListar" class="display table responsive table-hover nowrap table-condensed tableListar"   cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th class="table-header" >{$.i18n.prop("categoria.empresa")}       </th>
                                <th class="table-header" >{$.i18n.prop("categoria.descripcion")}   </th>
                                <th class="table-header" >{$.i18n.prop("categoria.created_at")}    </th>
                                <th class="table-header" >{$.i18n.prop("categoria.updated_at")}    </th>
                        ...
                        <tfoot style="display: table-header-group;">
                            <tr>
                                <th>{$.i18n.prop("categoria.empresa")}       </th>
                                <th>{$.i18n.prop("categoria.descripcion")}   </th>
                                <th>{$.i18n.prop("categoria.created_at")}    </th>
                                <th>{$.i18n.prop("categoria.updated_at")}    </th>
                    ...
                    <form id = "formulario" name ="formulario "   class="advanced-search-form">
                        ...
                        <div class="row">
                            <div class= "col-md-6 col-sx-12 col-sm-6 col-lg-6">
                                ...
                                <input type="text" class="form-control descripcion" id="descripcion" name="descripcion" value="{categoria.descripcion}"  >
...
function __MantenimientoAgregar(){
    ...
    $('.dataTables_wrapper').on('click','.btn-agregar',function(e){
        self.categoria    = {};                // modelo o domain   
...
__agregar(){
       if ($("#formulario").valid()) {
        ...
        swal({
           title: '',
           text: $.i18n.prop("categoria.mensaje.alert.agregar"),
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: '#00539B',
            cancelButtonColor: '#d33',
...
__Modificar(){
    ...
    self.exito = false;
    self.update();
    __modificarRegistro("#formulario",$.i18n.prop("categoria.mensaje.alert.modificar"),'ModificarCategoriaAjax.do','ListarCategoriasAjax.do','#tableListar')
}
...
function __InformacionDataTable(){
    self.informacion_tabla = [ 
                               {'data' :'empresa.nombre' ,"name":"empresa.nombre"  ,"title" : $.i18n.prop("categoria.empresa")     ,"autoWidth" :true },
                               {'data' :'descripcion'    ,"name":"descripcion"     ,"title" : $.i18n.prop("categoria.descripcion") ,"autoWidth" :true },
                               {'data' : 'created_at'        ,"name":"created_at"  ,"title" : $.i18n.prop("categoria.created_at")  ,"autoWidth" :false,
                                    "render":function(created_at,type, row){
                                        return __displayDate_detail(created_at);
                                    }
                                },
                                {'data' : 'updated_at'        ,"name":"updated_at" ,"title" : $.i18n.prop("categoria.updated_at")  ,"autoWidth" :false,
