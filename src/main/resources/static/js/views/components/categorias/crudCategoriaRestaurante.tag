            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    <form id = "formulario" name ="formulario "   class="advanced-search-form">
                        ...
                        <input type="hidden" name="fileB64" id="fileB64" class='fileB64' value="{categoria.imagen}">
                        <div class="row">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            <div class= "col-md-6 col-sx-12 col-sm-6 col-lg-6">
                                <label  >Imagen  <span class="requeridoDato">*</span></label>
                                <input id="imagenFile" name="imagenFile" class="imagenFile" type="file"  accept="image/*"  onchange= {cargaImagen}>

                            </div>
                              <div id="file-preview-zone">
    </div>
                            <div class= "col-md-6 col-sx-12 col-sm-6 col-lg-6">
                                 <img id="imagenMostrar" class="imagenMostrar" alt="" src="" width="250" height="250">
                            </div>
...
cargaImagen(){
    var imagenTem = $('#imagenFile')
    encodeImagetoBase64(imagenTem)
    cargarImagenBusca($('#fileB64').val(),$('#imagenMostrar'))
}
