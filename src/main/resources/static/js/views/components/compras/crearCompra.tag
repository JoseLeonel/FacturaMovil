...
function __calculate() {
    ...
    self.detail.forEach(function(e){
         self.compra.totalCompra += e.subTotal >0?e.subTotal:0
         self.compra.subTotal   += e.subTotal >0?e.subTotal:0
    });
    self.compra.total = self.compra.totalCompra - self.compra.totalDescuento
    self.compra.total = self.compra.totalCompra + self.compra.totalImpuesto
    self.articulo              = null;
    self.update(); 
    $( "#producto" ).val(null);
    $( "#quantity" ).val(null);
