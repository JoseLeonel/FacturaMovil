<motivoSalida-crud>
    ...
    <div  class="row titulo-encabezado"  >
        <div  class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
            <h1 ><i class="fa fa-cog"></i>&nbsp {$.i18n.prop("motivoSalida.titulo")}  </h1>
        </div>
            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    <form id = "formulario" name ="formulario "   class="advanced-search-form">
                        <input type="hidden" name="id" id="id" value="{motivoSalida.id}">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class= "col-md-12 col-sx-12 col-sm-12 col-lg-12">
                                <label  >{$.i18n.prop("motivoSalida.descripcion")}  <span class="requeridoDato">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sx-12 col-sm-12 col-lg-12">
                                <label >{$.i18n.prop("motivoSalida.estado")}</label>
...
function __MantenimientoAgregar(){
    ...
    $('.dataTables_wrapper').on('click','.btn-agregar',function(e){
        self.motivoSalida    = {};                // modelo o domain   
...
function __consultar(){
    ...
    $.ajax({
        url: "MostrarMotivoSalidaAjax.do",
        datatype: "json",
        data: formulario,
        method:"GET",
           ...
           text:$.i18n.prop("motivoSalida.mensaje.alert.agregar"),
            ...
            if(isConfirm){
                $.ajax({
                    ...
                    dataType : "json",
                    data : formulario,
                    url : 'AgregarMotivoSalidaAjax.do',
                    success : function(data) {
                        console.log(data);
                        if (data.status != 200) {
...
__Modificar(){
    ...
    self.exito = false;
    self.update();
    __modificarRegistro("#formulario",$.i18n.prop("motivoSalida.mensaje.alert.modificar"),'ModificarMotivoSalidaAjax.do','ListarMotivoSalidasAjax.do','#tableListar')
}
/**
...
function __listado(){
    ...
    $.ajax({
        url: "ListarMotivoSalidasAjax.do",
        datatype: "json",
        method:"GET",
        success: function (result) {
             if(result.aaData.length > 0){
