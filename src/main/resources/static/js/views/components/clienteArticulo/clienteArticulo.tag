            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    <form id = "formulario" name ="formulario "   class="advanced-search-form">
                        <input type="hidden" name="id" id="id" value="{clienteArticulo.id}">
                        <input type="hidden" id="cliente" name="cliente" value="{parametros.idProveedor}"  >
                        ...
                        <div class="row">
                            ...
                            <div class= "col-md-6 col-sx-12 col-sm-6 col-lg-6 has-success">
                                <label class="tamanoLetraTotales"  >{$.i18n.prop("articulo.descripcion")} </label>
                                <input type="number" step="any" class="campo descripcion" id="descripcion" name="descripcion" value="{clienteArticulo.descripcion}"  >
                            </div>
                        </div>
                    </form>    
                </div>
