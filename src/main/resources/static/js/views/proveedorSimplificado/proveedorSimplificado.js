...
var Listar = function(){
	...
	"lengthChange": true,
	"ajax" : {
			"url":"ListarProveedorSimplificadoAjax.do",
			"deferRender": true,
			"type":"GET",
					"dataType": 'json',
...
var idioma_espanol = 
{
 ...
 var informacion_tabla = [ 
								...
								{'data' : 'estadoSTR'         ,"name":"estadoSTR"               ,"title" : "Estado"              ,"autoWidth" :false},
...
function __MantenimientoAgregar(){
  ...
  $('.dataTables_wrapper').on('click','.btn-agregar',function(e){
	...
	riot.compile(function() {
		...
		var tags = riot.mount('proveedorsimplificado-crud',{parametros:parametros});
	});   
  })
}
...
function mostrarListadoPrincipal(){
	$("#mostrarListado").show();
	window.location.href = "ListarProveedorSimplificado.do";
}