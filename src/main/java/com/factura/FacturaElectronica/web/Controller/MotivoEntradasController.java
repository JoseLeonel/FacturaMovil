...
import com.factura.FacturaElectronica.web.command.MotivoEntradaCommand;
import com.factura.FacturaElectronica.web.componentes.EmpresaPropertyEditor;
import com.factura.FacturaElectronica.web.componentes.MotivoEntradaPropertyEditor;
...
public class MotivoEntradasController {
	...
	public RespuestaServiceDataTable listarActivasAjax(HttpServletRequest request, HttpServletResponse response, @RequestParam Integer idEmpresa) {
		...
		if (empresa != null) {
			...
			dataTableFilter = new DataTableFilter("empresa.id", "'" + empresa.getId().toString() + "'", "=");
			delimitadores.addFiltro(dataTableFilter);
