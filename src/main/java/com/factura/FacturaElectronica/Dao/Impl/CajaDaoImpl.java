...
public class CajaDaoImpl implements CajaDao {
	...
	/**
	 * Buscar una Caja
	 * @see com.factura.FacturaElectronica.Dao.CajaDao#buscar(java.lang.Long)
	 */
	@Override
	...
	/**
	 * Buscar por terminal
	 * @see com.factura.FacturaElectronica.Dao.CajaDao#findByTerminalAndEmpresa(java.lang.String, com.factura.FacturaElectronica.modelo.Empresa)
	 */
	@Override
