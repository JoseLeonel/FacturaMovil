...
public class Practica {
	...
	private static final String FILENAME = "/home/jose/mr-automatico/fe1617077760978-sinmata.xml";
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(facturaElectronica.getEmisor().getNombre());
		...
		for (RecepcionFacturaDetalle recepcionFacturaDetalle : list) {
			System.out.println("Linea:"+  recepcionFacturaDetalle.getNumeroLinea() + " Codigo:"+  recepcionFacturaDetalle.getCodigoCabys() + " Detalle:"+  recepcionFacturaDetalle.getDetalle());
			System.out.println("Cantidad:"+  recepcionFacturaDetalle.getCantidad() + " precio unitario:"+  recepcionFacturaDetalle.getPrecioUnitario() + " MontoTotal:"+  recepcionFacturaDetalle.getMontoTotalLinea());
...
//			log.error(String.format("--error Compra formateda del xml->resumenFacturaTotal :" + e.getMessage() + new Date()));
	...
	public static void printElement(Element element) {
		...
		System.out.println("attribute LineaDetalle: " + element.getAttribute("LineaDetalle"));
		System.out.println("element NumeroLinea: " + element.getElementsByTagName("NumeroLinea").item(0).getTextContent());
		System.out.println("element Codigo: " + element.getElementsByTagName("Codigo").item(0).getTextContent());
