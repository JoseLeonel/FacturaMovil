...
public class TotalbyImpuestosCommand {
	...
	public Double getTotal_descuentos() {
		if (tipo_doc != null && tipo_doc.equals(Constantes.FACTURA_TIPO_DOC_FACTURA_NOTA_CREDITO)) {
			return this.total_descuentos != null ? this.total_descuentos * -1 * this.tipo_cambio : this.total_descuentos * this.tipo_cambio;
		} else {
	...
	public Double getVenta_imp_01() {
		if (tipo_doc != null && tipo_doc.equals(Constantes.FACTURA_TIPO_DOC_FACTURA_NOTA_CREDITO)) {
			return this.venta_imp_01 != null ? this.venta_imp_01 * -1 * this.tipo_cambio : this.venta_imp_01 * this.tipo_cambio;
		} else {
			return this.venta_imp_01;
		}
	...
	public Double getVenta_imp_02() {
		if (tipo_doc != null && tipo_doc.equals(Constantes.FACTURA_TIPO_DOC_FACTURA_NOTA_CREDITO)) {
			return this.venta_imp_02 != null ? this.venta_imp_02 * -1 * this.tipo_cambio : this.venta_imp_02 * this.tipo_cambio;
		} else {
			return this.venta_imp_02;
		}
	...
	public Double getVenta_imp_03() {
		if (tipo_doc != null && tipo_doc.equals(Constantes.FACTURA_TIPO_DOC_FACTURA_NOTA_CREDITO)) {
			return this.venta_imp_03 != null ? this.venta_imp_03 * -1 * this.tipo_cambio : this.venta_imp_03 * this.tipo_cambio;
		} else {
			return this.venta_imp_03;
		}
	...
	public Double getVenta_imp_04() {
		if (tipo_doc != null && tipo_doc.equals(Constantes.FACTURA_TIPO_DOC_FACTURA_NOTA_CREDITO)) {
			return this.venta_imp_04 != null ? this.venta_imp_04 * -1 * this.tipo_cambio : this.venta_imp_04 * this.tipo_cambio;
		} else {
			return this.venta_imp_04;
		}
	...
	public Double getVenta_imp_05() {
		if (tipo_doc != null && tipo_doc.equals(Constantes.FACTURA_TIPO_DOC_FACTURA_NOTA_CREDITO)) {
			return this.venta_imp_05 != null ? this.venta_imp_05 * -1 * this.tipo_cambio : this.venta_imp_05 * this.tipo_cambio;
		} else {
			return this.venta_imp_05;
		}
	...
	public Double getVenta_imp_06() {
		if (tipo_doc != null && tipo_doc.equals(Constantes.FACTURA_TIPO_DOC_FACTURA_NOTA_CREDITO)) {
			return this.venta_imp_06 != null ? this.venta_imp_06 * -1 * this.tipo_cambio : this.venta_imp_06 * this.tipo_cambio;
		} else {
			return this.venta_imp_06;
		}
	...
	public Double getVenta_imp_07() {
		if (tipo_doc != null && tipo_doc.equals(Constantes.FACTURA_TIPO_DOC_FACTURA_NOTA_CREDITO)) {
			return this.venta_imp_07 != null ? this.venta_imp_07 * -1 * this.tipo_cambio : this.venta_imp_07 * this.tipo_cambio;
		} else {
			return this.venta_imp_07;
		}
	...
	public Double getVenta_imp_08() {
		if (tipo_doc != null && tipo_doc.equals(Constantes.FACTURA_TIPO_DOC_FACTURA_NOTA_CREDITO)) {
			return this.venta_imp_08 != null ? this.venta_imp_08 * -1 * this.tipo_cambio : this.venta_imp_08 * this.tipo_cambio;
		} else {
			return this.venta_imp_08;
		}
