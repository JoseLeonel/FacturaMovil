...
//		Cliente cliente = clienteBo.buscarPorCedulaYEmpresa(idClienteParam, usuario.getEmpresa());
	...
	private ByteArrayOutputStream createExcelVentasXCodigo(Collection<Detalle> detalles) {
		...
		List<String> headers = Arrays.asList("Usuario", "Fecha Emision", "Codigo", "Descripcion", "Clave", "# Documento","#Proforma", "Cedula", "Cliente", "Cantidad", "Precio Unitario", "Monto Total", "Descuento", "%Impuesto", "Impuestos", "Total", "Tipo Moneda", "Tipo Cambio");
