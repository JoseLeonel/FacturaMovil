...
public interface DetalleBo {
  ...
  Collection<Detalle>  findbyIdFactura (Long idFactura);
	...
	ByteArrayInputStream createExcelVentasXCodigo(ArrayList<TotalbyImpuestosCommand> detalles,String fechaInicio, String fechaFinal, Empresa empresa, String actividadEconomica) throws Exception ;
	...
	List<Map<String, Object>>  ventasbyArticulo(String fechaInicial ,String fechaFinal,String codigoArticulo,Integer idEmpresa,Integer estado);
	 ByteArrayInputStream ventasbyArticuloExcel(String fechaInicial ,String fechaFinal,String codigoArticulo,Integer idEmpresa,Integer estado) throws IOException ;
}
