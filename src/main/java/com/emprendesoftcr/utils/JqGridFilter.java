...
public class JqGridFilter {
	...
	public JqGridFilter(HttpServletRequest request, @SuppressWarnings("rawtypes") Class clazz) {
	...
	public JqGridFilter(String campo, String valor, String operadorBusqueda) {
		this.campo = campo;
