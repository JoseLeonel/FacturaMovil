...
// Generated on: 2021.04.29 at 08:21:36 PM CST 
//


package com.emprendesoftcr.xml.schema.NotaDebitoschema;
...
public class NotaDebitoElectronicaSchema {
    ...
    protected NotaDebitoElectronicaSchema.DetalleServicio detalleServicio;
    ...
    protected NotaDebitoElectronicaSchema.ResumenFactura resumenFactura;
    ...
    protected List<NotaDebitoElectronicaSchema.InformacionReferencia> informacionReferencia;
    @XmlElement(name = "Otros", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica")
    protected NotaDebitoElectronicaSchema.Otros otros;
     ...
     * @return
     *     possible object is
     *     {@link NotaDebitoElectronicaSchema.DetalleServicio }
     *     
     */
    public NotaDebitoElectronicaSchema.DetalleServicio getDetalleServicio() {
     ...
     *     
     */
    public void setDetalleServicio(NotaDebitoElectronicaSchema.DetalleServicio value) {
     ...
     * @return
     *     possible object is
     *     {@link NotaDebitoElectronicaSchema.ResumenFactura }
     *     
     */
    public NotaDebitoElectronicaSchema.ResumenFactura getResumenFactura() {
     ...
     *     
     */
    public void setResumenFactura(NotaDebitoElectronicaSchema.ResumenFactura value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NotaDebitoElectronicaSchema.InformacionReferencia }
     * 
     * 
     */
    public List<NotaDebitoElectronicaSchema.InformacionReferencia> getInformacionReferencia() {
        if (informacionReferencia == null) {
            informacionReferencia = new ArrayList<NotaDebitoElectronicaSchema.InformacionReferencia>();
        }
     ...
     * @return
     *     possible object is
     *     {@link NotaDebitoElectronicaSchema.Otros }
     *     
     */
    public NotaDebitoElectronicaSchema.Otros getOtros() {
        return otros;
    }
     ...
     *     
     */
    public void setOtros(NotaDebitoElectronicaSchema.Otros value) {
        this.otros = value;
    }
    ...
    public static class DetalleServicio {
        ...
        protected List<NotaDebitoElectronicaSchema.DetalleServicio.LineaDetalle> lineaDetalle;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link NotaDebitoElectronicaSchema.DetalleServicio.LineaDetalle }
         * 
         * 
         */
        public List<NotaDebitoElectronicaSchema.DetalleServicio.LineaDetalle> getLineaDetalle() {
            if (lineaDetalle == null) {
                lineaDetalle = new ArrayList<NotaDebitoElectronicaSchema.DetalleServicio.LineaDetalle>();
            }
    ...
    public static class InformacionReferencia {
        ...
        @XmlElement(name = "Numero", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica")
        ...
        protected String codigo;
        @XmlElement(name = "Razon", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica")
    ...
    public static class Otros {
        ...
        protected List<NotaDebitoElectronicaSchema.Otros.OtroTexto> otroTexto;
        @XmlElement(name = "OtroContenido", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica")
        protected List<NotaDebitoElectronicaSchema.Otros.OtroContenido> otroContenido;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link NotaDebitoElectronicaSchema.Otros.OtroTexto }
         * 
         * 
         */
        public List<NotaDebitoElectronicaSchema.Otros.OtroTexto> getOtroTexto() {
            if (otroTexto == null) {
                otroTexto = new ArrayList<NotaDebitoElectronicaSchema.Otros.OtroTexto>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link NotaDebitoElectronicaSchema.Otros.OtroContenido }
         * 
         * 
         */
        public List<NotaDebitoElectronicaSchema.Otros.OtroContenido> getOtroContenido() {
            if (otroContenido == null) {
                otroContenido = new ArrayList<NotaDebitoElectronicaSchema.Otros.OtroContenido>();
            }
