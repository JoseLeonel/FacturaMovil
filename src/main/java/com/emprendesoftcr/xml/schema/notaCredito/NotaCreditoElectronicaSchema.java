...
public class NotaCreditoElectronicaSchema {
    ...
    protected NotaCreditoElectronicaSchema.DetalleServicio detalleServicio;
    ...
    protected NotaCreditoElectronicaSchema.ResumenFactura resumenFactura;
    ...
    protected List<NotaCreditoElectronicaSchema.InformacionReferencia> informacionReferencia;
    @XmlElement(name = "Otros", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica")
    protected NotaCreditoElectronicaSchema.Otros otros;
     ...
     * @return
     *     possible object is
     *     {@link NotaCreditoElectronicaSchema.DetalleServicio }
     *     
     */
    public NotaCreditoElectronicaSchema.DetalleServicio getDetalleServicio() {
     ...
     *     
     */
    public void setDetalleServicio(NotaCreditoElectronicaSchema.DetalleServicio value) {
     ...
     * @return
     *     possible object is
     *     {@link NotaCreditoElectronicaSchema.ResumenFactura }
     *     
     */
    public NotaCreditoElectronicaSchema.ResumenFactura getResumenFactura() {
     ...
     *     
     */
    public void setResumenFactura(NotaCreditoElectronicaSchema.ResumenFactura value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NotaCreditoElectronicaSchema.InformacionReferencia }
     * 
     * 
     */
    public List<NotaCreditoElectronicaSchema.InformacionReferencia> getInformacionReferencia() {
        if (informacionReferencia == null) {
            informacionReferencia = new ArrayList<NotaCreditoElectronicaSchema.InformacionReferencia>();
        }
     ...
     * @return
     *     possible object is
     *     {@link NotaCreditoElectronicaSchema.Otros }
     *     
     */
    public NotaCreditoElectronicaSchema.Otros getOtros() {
        return otros;
    }
     ...
     *     
     */
    public void setOtros(NotaCreditoElectronicaSchema.Otros value) {
        this.otros = value;
    }
    ...
    public static class DetalleServicio {
        ...
        protected List<NotaCreditoElectronicaSchema.DetalleServicio.LineaDetalle> lineaDetalle;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link NotaCreditoElectronicaSchema.DetalleServicio.LineaDetalle }
         * 
         * 
         */
        public List<NotaCreditoElectronicaSchema.DetalleServicio.LineaDetalle> getLineaDetalle() {
            if (lineaDetalle == null) {
                lineaDetalle = new ArrayList<NotaCreditoElectronicaSchema.DetalleServicio.LineaDetalle>();
            }
    ...
    public static class InformacionReferencia {
        ...
        @XmlElement(name = "Numero", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica")
        ...
        protected String codigo;
        @XmlElement(name = "Razon", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica")
    ...
    public static class Otros {
        ...
        protected List<NotaCreditoElectronicaSchema.Otros.OtroTexto> otroTexto;
        @XmlElement(name = "OtroContenido", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica")
        protected List<NotaCreditoElectronicaSchema.Otros.OtroContenido> otroContenido;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link NotaCreditoElectronicaSchema.Otros.OtroTexto }
         * 
         * 
         */
        public List<NotaCreditoElectronicaSchema.Otros.OtroTexto> getOtroTexto() {
            if (otroTexto == null) {
                otroTexto = new ArrayList<NotaCreditoElectronicaSchema.Otros.OtroTexto>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link NotaCreditoElectronicaSchema.Otros.OtroContenido }
         * 
         * 
         */
        public List<NotaCreditoElectronicaSchema.Otros.OtroContenido> getOtroContenido() {
            if (otroContenido == null) {
                otroContenido = new ArrayList<NotaCreditoElectronicaSchema.Otros.OtroContenido>();
            }
