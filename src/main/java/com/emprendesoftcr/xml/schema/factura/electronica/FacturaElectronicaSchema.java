...
public class FacturaElectronicaSchema {
    ...
    protected FacturaElectronicaSchema.DetalleServicio detalleServicio;
    ...
    protected FacturaElectronicaSchema.ResumenFactura resumenFactura;
    ...
    protected List<FacturaElectronicaSchema.InformacionReferencia> informacionReferencia;
    @XmlElement(name = "Otros", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica")
    protected FacturaElectronicaSchema.Otros otros;
     ...
     * @return
     *     possible object is
     *     {@link FacturaElectronicaSchema.DetalleServicio }
     *     
     */
    public FacturaElectronicaSchema.DetalleServicio getDetalleServicio() {
     ...
     *     
     */
    public void setDetalleServicio(FacturaElectronicaSchema.DetalleServicio value) {
     ...
     * @return
     *     possible object is
     *     {@link FacturaElectronicaSchema.ResumenFactura }
     *     
     */
    public FacturaElectronicaSchema.ResumenFactura getResumenFactura() {
     ...
     *     
     */
    public void setResumenFactura(FacturaElectronicaSchema.ResumenFactura value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FacturaElectronicaSchema.InformacionReferencia }
     * 
     * 
     */
    public List<FacturaElectronicaSchema.InformacionReferencia> getInformacionReferencia() {
        if (informacionReferencia == null) {
            informacionReferencia = new ArrayList<FacturaElectronicaSchema.InformacionReferencia>();
        }
     ...
     * @return
     *     possible object is
     *     {@link FacturaElectronicaSchema.Otros }
     *     
     */
    public FacturaElectronicaSchema.Otros getOtros() {
        return otros;
    }
     ...
     *     
     */
    public void setOtros(FacturaElectronicaSchema.Otros value) {
        this.otros = value;
    }
    ...
    public static class DetalleServicio {
        ...
        protected List<FacturaElectronicaSchema.DetalleServicio.LineaDetalle> lineaDetalle;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link FacturaElectronicaSchema.DetalleServicio.LineaDetalle }
         * 
         * 
         */
        public List<FacturaElectronicaSchema.DetalleServicio.LineaDetalle> getLineaDetalle() {
            if (lineaDetalle == null) {
                lineaDetalle = new ArrayList<FacturaElectronicaSchema.DetalleServicio.LineaDetalle>();
            }
    ...
    public static class InformacionReferencia {
        ...
        @XmlElement(name = "Numero", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica")
        ...
        protected String codigo;
        @XmlElement(name = "Razon", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica")
    ...
    public static class Otros {
        ...
        protected List<FacturaElectronicaSchema.Otros.OtroTexto> otroTexto;
        @XmlElement(name = "OtroContenido", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica")
        protected List<FacturaElectronicaSchema.Otros.OtroContenido> otroContenido;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link FacturaElectronicaSchema.Otros.OtroTexto }
         * 
         * 
         */
        public List<FacturaElectronicaSchema.Otros.OtroTexto> getOtroTexto() {
            if (otroTexto == null) {
                otroTexto = new ArrayList<FacturaElectronicaSchema.Otros.OtroTexto>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link FacturaElectronicaSchema.Otros.OtroContenido }
         * 
         * 
         */
        public List<FacturaElectronicaSchema.Otros.OtroContenido> getOtroContenido() {
            if (otroContenido == null) {
                otroContenido = new ArrayList<FacturaElectronicaSchema.Otros.OtroContenido>();
            }
