...
@Lazy
@Service("notaDebitoXMLService")
@Transactional
public class NotaDebitoXMLServiceImpl implements NotaDebitoXMLService {
    ...
    String xml = "<NotaDebitoElectronica xmlns=\"" + Constantes.DOCXMLS_NOTA_DEBITO + "\" " +
        ...
        "<TotalComprobante>" +  FacturaElectronicaUtils.getConvertirBigDecimal(factura.getTotalComprobante()) + "</TotalComprobante>" +
           "</ResumenFactura>" +
            "<InformacionReferencia>" +
                ...
                "<FechaEmision>" + factura.getReferenciaFechaEmision() + "</FechaEmision>" +
