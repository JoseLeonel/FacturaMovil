...
import com.emprendesoftcr.xml.schema.notaCredito.CodigoType;
import com.emprendesoftcr.xml.schema.notaCredito.DescuentoType;
import com.emprendesoftcr.xml.schema.notaCredito.EmisorType;
import com.emprendesoftcr.xml.schema.notaCredito.ImpuestoType;
import com.emprendesoftcr.xml.schema.notaCredito.ReceptorType;
import com.emprendesoftcr.xml.schema.notaCredito.NotaCreditoElectronicaSchema;

@EnableTransactionManagement
@Service("notaCreditoElectronicaSchemaBo")
public class NotaCreditoElectronicaSchemaBoImpl implements NotaCreditoElectronicaSchemaBo {
	...
	public void aplicarFacturaXMLToModelo(String ruta, Empresa empresa, Usuario usuarioSesion, String condicionImpuesto, Integer tipoGasto, String codigoActividad, String mensaje, String detalleMensaje) throws Exception {
		...
		try {
			...
			JAXBContext jAXBContext = JAXBContext.newInstance(NotaCreditoElectronicaSchema.class);

			Unmarshaller jaxbUnmarshaller = jAXBContext.createUnmarshaller();
			NotaCreditoElectronicaSchema notaCreditoElectronicaSchema = (NotaCreditoElectronicaSchema) jaxbUnmarshaller.unmarshal(file);
			...
			recepcionFactura = resumenFacturaTotal(notaCreditoElectronicaSchema.getResumenFactura(), recepcionFactura);
