...
@BaseNativeQuery(name = "haciendaComprobar", query = "SELECT hacienda_xml.id,hacienda_xml.consecutivo,hacienda_xml.empresa_id, hacienda_xml.reintentos_aceptacion, hacienda_xml.created_at, hacienda_xml.estado, hacienda_xml.tipo_doc ,empresas.nombre FROM hacienda_xml " 
